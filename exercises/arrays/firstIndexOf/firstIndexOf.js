...
if (require.main === module) {
  console.log('Running sanity checks for firstIndexOf:', firstIndexOf([10, 20, 30, 20], 20), firstIndexOf([10, 20, 30, 20], 17), firstIndexOf(['giraffe', 'giraffe', 'banana'], 'giraffe'));
